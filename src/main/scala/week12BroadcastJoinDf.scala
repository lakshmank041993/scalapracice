...
object week12BroadcastJoinDf extends App {
  ...
  val joinedDf = ordersDf.join(broadcast(customersDf),ordersDf.col("order_customer_id")=== customersDf.col("customer_id"),"inner")
