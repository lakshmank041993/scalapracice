...
object week12WriteToAvro extends App {
  ...
  csvload.write.format("avro").partitionBy("order_status").option("maxRecordsPerFile", 500).mode(SaveMode.Overwrite).option("path", "/home/rithwick/Downloads/week12_op_avro_maxRecordsPerfile_folder").save
